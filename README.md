...
-Historical Phases and Decay analysis: the library stresses the IfcSurfaceFeature, a subclass of IfcSurfaceFeature that can represent as a 'USERDEFINED' a decay-analyzed surface.
